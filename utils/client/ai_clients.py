...
from utils.client.client_base import BaseClientManager, logger
...
class AIClients(BaseClientManager):
    ...
    # ── BGE-重排序模型客户端 ──
    @classmethod
    def get_bge_rerank_client(cls):
        return cls._get_or_create("_bge_rerank_client",
                                  cls._bge_rerank_lock,
                                  cls._create_bge_rerank_client)

    @classmethod
    def _create_bge_rerank_client(cls):
        """
        创建bge_m3 重排序模型客户端
        Returns:
        """
